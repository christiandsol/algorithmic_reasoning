...
def write_chat_format(reasoning_strategy, data_sect, data):
    ...
    for idx in data:
        ...
        #     print("-------------")
    write_json(f"/local2/solano/algorithmic_reasoning/data_samples/{data_sect}_sample.json", llama_data)
...
def parse_args():
    ...
    parser.add_argument("-graph_sizes", "--graph_sizes", type=list, default=[10], help="Number of nodes present in the graphs generated. Default behavior sets num_samples to the number of training datapoints.")
    ...
    parser.add_argument("-train_test_split", "--train_test_split", type=list, default=[10, 10], help="Training/Testing split ratios. The Test set will be equally split into Validation and Test.")
